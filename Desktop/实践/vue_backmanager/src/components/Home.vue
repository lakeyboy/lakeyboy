  ...
  <el-container class="home_container">
    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ?'64px':'200px'">
        ...
        <!-- 侧边栏区域 -->
        <el-menu background-color="#545c64" text-color="#fff" active-text-color="#21a0ff" :unique-opened="true" :collapse="isCollapse" :collapse-transition="false" router :default-active="activePath">
          <!-- 这是一级菜单 -->
